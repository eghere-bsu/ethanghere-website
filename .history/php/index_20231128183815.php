  ...
  <ul class="portfolio-cards">
    <li class="portfolio-card">
      ...
      <div class="card-content">
        <h3>Title Name</h3>
        <p>Description of the portfolio piece.</p>
    ...
    <li class="portfolio-card">
      ...
      <div class="card-content">
        <h3>Title Name 2</h3>
        <p>Description of the portfolio piece 2.</p>
        <span>Category Type 2</span>
      </div>
    </li>
    <li class="portfolio-card">
      <div class="card-image">
      ...
      <div class="card-content">
        <h3>Title Name 3</h3>
        <p>Description of the portfolio piece 3.</p>
        <span>Category Type 3</span>
      </div>
    </li>
  </ul>
  </section>
