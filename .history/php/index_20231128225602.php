  ...
  <div class="modal" id="post-modal">
    <div class="modal-content">
      ...
      <form action="post_handler.php" method="post" enctype="multipart/form-data">
        ...
        <input placeholder="Image URL: " type="text" id="image_url" name="image_url" value="<?php echo isset($_SESSION['post_data']['image_url']) ? htmlspecialchars($_SESSION['post_data']['image_url'], ENT_QUOTES, 'UTF-8') : ''; ?>"><br>
