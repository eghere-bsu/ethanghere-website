...
<body>
  ...
  <section id="about">
    ...
    <div class="about-container">
      <div class="left">
        <p>
          I learned from a young age that I have best expressed my creative prowess through a computer. Whether the medium is music or a Linux terminal, I've channeled my knowledge to design projects that excel in both form and function. 
        </p><p>
          Currently, I am studying computer science at Boise State University. It is here that I've fostered my passion for software development. I believe the best design is one that's not noticed; I strive to create intuitive experiences which best reflect my creativity.
        </p>
      </div>
      <div class="right">
