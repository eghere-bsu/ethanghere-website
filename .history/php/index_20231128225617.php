  ...
  <div class="modal" id="post-modal">
    <div class="modal-content">
      ...
      <form action="post_handler.php" method="post" enctype="multipart/form-data">
        ...
        <input placeholder="Category: " type="text" id="category" name="category" value="<?php echo isset($_SESSION['post_data']['category']) ? htmlspecialchars($_SESSION['post_data']['category'], ENT_QUOTES, 'UTF-8') : ''; ?>"><br>
