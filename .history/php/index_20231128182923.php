    ...
    <li class="portfolio-item">
      <div class="portfolio-content">
        <div class="portfolio-image">
          <img src="https://i.ytimg.com/vi/_rXWAljAThs/hqdefault.jpg">
        </div>
        <div class="portfolio-details">
          <h3>Title Name</h3>
          <p class="description">Description of the portfolio piece</p>
          <p class="category">Category Type</p>
          <a href="#" class="learn-more-btn">Learn More</a>
        </div>
      </div>
    </li>
    <!-- Add more li elements for additional portfolio items -->
  </ul>
</section>
  <!-- Skills -->
  <section id="skills">
