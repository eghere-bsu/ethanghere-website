  ...
  <div class="portfolio-container">
    <div class="portfolio-card">
        <div class="portfolio-card-image">
            <img src="image.jpg" alt="Portfolio project image">
        </div>
        <div class="portfolio-card-content">
            <h3 class="portfolio-card-title">Project Title</h3>
            <p class="portfolio-card-description">Project description goes here.</p>
            <span class="portfolio-card-category">Category: Web Development</span>
            <a href="https://github.com/your-username/project-name" class="portfolio-card-link">View on GitHub</a>
        </div>
    </div>
  </div>
  </section>
