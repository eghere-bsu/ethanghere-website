...
<body>
  ...
  <div class="modal" id="post-modal">
    <div class="modal-content">
      ...
      <form method="post" action="post_handler.php" enctype="multipart/form-data" id="post-form">
        ...
        <textarea placeholder="Description: " id="description" name="description" rows="4" cols="50"><?php echo isset($_SESSION['post_data']['description']) ? htmlspecialchars($_SESSION['post_data']['description'], ENT_QUOTES, 'UTF-8') : ''; ?></textarea>

        <input placeholder="Post Link: " type="text" id="post_link" name="post_link" value="<?php echo isset($_SESSION['post_data']['post_link']) ? htmlspecialchars($_SESSION['post_data']['post_link'], ENT_QUOTES, 'UTF-8') : ''; ?>"><br>

        <input placeholder="Image URL: " type="text" id="image_url" name="image_url" value="<?php echo isset($_SESSION['post_data']['image_url']) ? htmlspecialchars($_SESSION['post_data']['image_url'], ENT_QUOTES, 'UTF-8') : ''; ?>">

        <input placeholder="Category: " type="text" id="category" name="category" value="<?php echo isset($_SESSION['post_data']['category']) ? htmlspecialchars($_SESSION['post_data']['category'], ENT_QUOTES, 'UTF-8') : ''; ?>">
