  ...
  <div class="card-container">
    <ul>
      <li class="card">
        ...
        <div class="right">
          <h3>Title</h3>
          <p>This is a description of a portfolio card. Some text would go here to simulate what it would be like if I had some text here. Isn't that great? Boobs butt vagina nigger balls. </p>
        </div>
      </li>
    </ul>
  </div>
