...
<body>
  ...
  <section id="about">
    ...
    <div class="about-container">
      <div class="left">
        <p>
          I learned from a young age that I have best expressed my creative prowess through some technological means. Whether it be an infographic or a terminal interface, I've channeled my knowledge to design projects that excel in both form and function. 

          Currently, I am studying computer science at Boise State University. It is here that I've fostered my passion for software development. I aspire to create applications and experiences which are pleasant to interact with. 
        </p>
      </div>
      <div class="right">
