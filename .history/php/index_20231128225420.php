  ...
  <div class="modal" id="post-modal">
    <div class="modal-content">
      ...
      <form action="post_handler.php" method="post" enctype="multipart/form-data">
        <input placeholder="Title: " type="text" id="title" name="title" value="<?php echo isset($_SESSION['post_data']['title']) ? htmlspecialchars($_SESSION['post_data']['title'], ENT_QUOTES, 'UTF-8') : ''; ?>" required><br>
